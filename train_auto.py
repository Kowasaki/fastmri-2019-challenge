...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 01:51:04 2019
...
from models.unet.unet_model import UnetModel, CustomUnetModel, UnetAuto
#from models.dense.tiramisu import FCDenseNet57,FCDenseNet67,FCDenseNet103
...
def train_epoch(args, loss_func, epoch, model, data_loader, optimizer, writer):
    ...
    for iter, data in enumerate(data_loader):
        ...
        output = model(target.unsqueeze(1))[0].squeeze(1)
